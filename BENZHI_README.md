# courier-slot-coordinator__005 Docker 交付说明
...
```bash
./build_benzhi_docker.sh courier-slot-coordinator__005-benzhi linux/amd64
docker run --rm -it courier-slot-coordinator__005-benzhi bash
```
