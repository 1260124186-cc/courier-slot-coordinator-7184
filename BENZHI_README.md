# courier-slot-coordinator__001 Docker 交付说明
...
```bash
./build_benzhi_docker.sh courier-slot-coordinator__001-benzhi linux/amd64
docker run --rm -it courier-slot-coordinator__001-benzhi bash
```
